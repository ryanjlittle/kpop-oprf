...
from sagelib.hash_to_field import I2OSP, OS2IP, expand_message_xmd, expand_message_xof, XMDExpander, hash_to_field
...
class GroupP256(GroupNISTCurve):
    ...
    def hash_to_group(self, msg, dst):
        h2csuite = p256_sswu_ro
        h2csuite.expand._dst = dst
        return h2csuite(msg)
